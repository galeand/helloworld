...
//
//import com.ele.helloword.bean.domain.Audience;
...
// * @name: JwtTokenUtil
// * @author: xiangyf
// * @create: 2019-08-19 21:48
// * @description: Json Web Token（JWT）：JSON网络令牌，是为了在网络应用环境间传递声明而制定的一种基于JSON的开放标准（(RFC 7519)。JWT是一个轻便的安全跨平台传输格式，定义了一个紧凑的自包含的方式用于通信双方之间以 JSON 对象行使安全的传递信息。因为数字签名的存在，这些信息是可信的。
// * JWT的组成
// * <p>
// * JWT含有三个部分：
// * <p>
